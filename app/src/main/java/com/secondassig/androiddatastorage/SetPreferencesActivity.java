...
public class SetPreferencesActivity extends Activity {
	...
	public void onSave(View view)
	{
		...
		if(name!=null && author!=null && description!=null)
		{
			try 
			{
				...
				editor.putString("AuthorName", author);
	...
	{
		SharedPreferences sharedPrefs = PreferenceManager.getDefaultSharedPreferences(this);
		String bookName = sharedPrefs.getString("BookName", null);
		String authorName = sharedPrefs.getString("AuthorName", null);
		String bookDescription = sharedPrefs.getString("BookDescription", null);

		// Display the preferences values
		EditText name_text=(EditText)findViewById(R.id.bookname_value);
		name_text.setText(bookName);
		EditText author_text=(EditText)findViewById(R.id.bookauthor_value);
		author_text.setText(authorName);
		EditText des_text=(EditText)findViewById(R.id.description_value);
		des_text.setText(bookDescription);
	}
}
